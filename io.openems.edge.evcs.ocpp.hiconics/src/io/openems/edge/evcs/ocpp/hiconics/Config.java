package io.openems.edge.evcs.ocpp.hiconics;

import org.osgi.service.metatype.annotations.AttributeDefinition;
import org.osgi.service.metatype.annotations.ObjectClassDefinition;

@ObjectClassDefinition(//
		name = "EVCS OCPP Hiconics", //
		description = "Implements an OCPP capable Hiconics electric vehicle charging station without the smart charging function.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "io.openems.edge.evcs.ocpp.hiconics [{id}]";
